...
*** Code for formatting "edu_spend_1980" ****
/* insheet using https://raw.githubusercontent.com/nikhildevmurthy/Nikhil/main/edu_spending.csv
drop in 1
rename v1 state
rename v2 year
rename v3 edu_spending
save educ_spending, replace */
/* The reason this code is in comment form is because for some reason the merge fails when i bring 
this particular dataset from the internet, but it merges successfully when I download it and save it in dta format */ 
...
merge 1:1 state using 1980_education_spending 
...
tab _merge 
/* There are 12 unmatched from using. This is because the data from the Department 
